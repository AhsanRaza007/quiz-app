    ...
    root.innerHTML=`
                <div id="start-component" class="text-center d-flex justify-content-center align-items-center" style="height:100vh;">
                    <div style="width:500px;">
                        <h1 class="display-4 text-primary font-weight-bold">Quick Quiz</h1>
                        <button class="btn rounded-0 btn-lg btn-primary d-block my-5" style="width:100%" id="home" onclick="getQuestions()">Play</button>
                        <button class="btn rounded-0 btn-lg btn-primary d-block my-5" id="high-scores" style="width:100%;" onclick="renderHighScores()">High Scores</button>
                    </div>    
                </div>
...
function renderDriver(questionNumber, selectedAnswer){
...
function createQuestionPage(questionNumber, question, option1, option2, option3, answer){
    ...
    option0id.addEventListener('click',()=>{renderDriver(questionNumber, answerOptions[radnomOptionIndex[0]])});
    option1id.addEventListener('click',()=>{renderDriver(questionNumber, answerOptions[radnomOptionIndex[1]])});
    option2id.addEventListener('click',()=>{renderDriver(questionNumber, answerOptions[radnomOptionIndex[2]])});
    option3id.addEventListener('click',()=>{renderDriver(questionNumber, answerOptions[radnomOptionIndex[3]])});
}
...
function renderFinalpage(){
    ...
    gameContainer.innerHTML=`<div class="row text-center" style="width:100%;">
                                <h3 class="display-3 col-12 text-info my-1">${score}</h3>
    ...
    document.getElementById('go-home-btn').addEventListener('click', renderRoot);
}
...
function renderHighScores(){
    ...
    root.innerHTML=`
                        <div id="start-component" class="text-center d-flex justify-content-center align-items-center" style="height:100vh;">
                            <div style="width:500px;">
                                <h1 class="display-4 text-info font-weight-bold">High Scores</h1>
                                ${
